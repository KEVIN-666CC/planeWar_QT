...
#include "../../PlaneGameLite/gameoverwidget.h"
...
QT_MOC_LITERAL(1, 15, 12), // "returnWindow"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 14), // "returnbtnclick"
QT_MOC_LITERAL(4, 44, 12) // "quitbtnclick"

    },
    "GameOverWidget\0returnWindow\0\0"
    "returnbtnclick\0quitbtnclick"
};
...
void GameOverWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->returnWindow(); break;
        case 1: _t->returnbtnclick(); break;
        case 2: _t->quitbtnclick(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameOverWidget::returnWindow)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameOverWidget::returnWindow()
{
